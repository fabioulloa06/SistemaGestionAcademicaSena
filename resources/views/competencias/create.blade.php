    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex justify-start">
                <a href="{{ route('programs.competencias.index', $program) }}" class="inline-flex items-center px-4 py-2 bg-gray-200 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300 focus:bg-gray-300 active:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                <div class="p-4 bg-gradient-to-r from-sena-50 to-sena-100 border-b border-sena-200">
                    <p class="text-sm text-gray-700">
                        <span class="font-semibold">Programa:</span> {{ $program->nombre }}
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                ...
                <form action="{{ route('programs.competencias.store', $program) }}" method="POST" class="p-6 space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">Código único según normativa SENA</p>
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               placeholder="Ej: APLICACIÓN DE CONOCIMIENTOS DE LAS CIENCIAS NATURALES..."
