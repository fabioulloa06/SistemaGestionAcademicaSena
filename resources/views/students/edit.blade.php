            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200">
                ...
                <form action="{{ route('students.update', $student) }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <x-searchable-select name="group_id" placeholder="Seleccione una ficha..." :value="old('group_id', $student->group_id)">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" 
                               ...
                               {{ old('activo', $student->activo) ? 'checked' : '' }}>
